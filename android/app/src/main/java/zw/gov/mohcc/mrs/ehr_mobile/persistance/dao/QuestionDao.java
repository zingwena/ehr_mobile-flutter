...
public interface QuestionDao {
    ...
    @Query("SELECT q.* FROM Question q inner join QuestionCategory c on c.code=q.categoryId where c.workArea=:workArea and q.categoryId=:categoryId Order by name ASC")
