                    ...
                    public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
                        ...
                        if (methodCall.method.equals("htsRegistration")) {
                            try{
                                ...
                                Hts hts = new Hts();
                                hts.setId(hts_Id);
                                hts.setPersonId(htsRegDTO.getPersonId());
                                ...
                                System.out.println(">>>>>>>>>>>>>>.. this is the person ID"+ htsRegDTO.getPersonId());
                                ehrMobileDatabase.htsDao().createHts(hts);
                                Person person = ehrMobileDatabase.personDao().findPatientById(htsRegDTO.getPersonId());
                                System.out.println("HERE IS THE PERSON FROM DB " + person.getFirstName() + ">>>>>>"+ person.getLastName());
