...
@Database(entities = {User.class, Authorities.class, Country.class, MaritalStatus.class, Patient.class, Facility.class, Religion.class, Nationality.class, TestKit.class, Occupation.class, EducationLevel.class, BloodPressure.class, Temperature.class, RespiratoryRate.class, Weight.class, Height.class, Pulse.class, Visit.class, ReasonForNotIssuingResult.class, PreTest.class, PostTest.class, HtsModel.class, EntryPoint.class, Purpose_Of_Tests.class}, version = 1, exportSchema = false)
