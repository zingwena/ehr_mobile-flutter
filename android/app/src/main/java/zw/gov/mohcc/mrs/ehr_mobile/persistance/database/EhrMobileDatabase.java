...
@Database(entities = {User.class, Authorities.class, Country.class, MaritalStatus.class, Person.class,
        ...
        FollowUpStatus.class, FunctionalStatus.class, FamilyPlanningStatus.class, LactatingStatus.class, MedicineName.class}, version = 2, exportSchema = false)
            ...
            synchronized (EhrMobileDatabase.class) {
                if (INSTANCE == null) {
                    ...
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            EhrMobileDatabase.class, "impilo")
