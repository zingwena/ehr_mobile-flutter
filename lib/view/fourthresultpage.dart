...
class FourthHts_Result extends StatefulWidget {
  String visitId;
  String patientId;
  String labInvetsTestId;
  String result_string;

  FourthHts_Result(this.patientId, this.labInvetsTestId, this.visitId, this.result_string);
...
class _Hts_Result  extends State<FourthHts_Result > {
...
//    patient id
    ...
    final_result = widget.result_string;
