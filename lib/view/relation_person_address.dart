...
class RelationPatientAddress extends StatefulWidget {
  ...
  RelationPatientAddress(this.patient_relative,  this.patient_personId, this._current_person, this.visitId, this.htsId,
      this.htsRegistration);
...
class _PatientAddressState extends State<RelationPatientAddress> {
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text("Relation Person Address", style: TextStyle(
                                                    ...
                                                    Container(
                                                      ...
                                                      child:   RaisedButton(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: <Widget>[
                                                            Text('Save Relation Patient Record', style: TextStyle(color: Colors.white),),
                                                            Spacer(),
                                                        ...
                                                        onPressed: () async {
                                                          if (_formKey.currentState.validate()) {
                                                            ...
                                                            if(_formIsValid){
                                                              Person patient = widget.patient_relative;
                                                              ...
                                                              await registerPatient(patient).then((value) {
                                                                Navigator.push(
                                                                    context,
                                                                    MaterialPageRoute(
                                                                        builder: (context) => PatientRelationOverview(registeredPatient, widget.patient_personId, widget.visitId, widget.htsId, widget.htsRegistration, widget._current_person)));
                                                              });
                                                              SnackBar(
