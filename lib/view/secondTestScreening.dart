...
class SecondHtsScreeningTest extends StatefulWidget {
...
class _HtsScreeningTest extends State<SecondHtsScreeningTest> {
                                                  ...
                                                  if (_formIsValid) {
                                                    ...
                                                    Navigator.push(context,
                                                        MaterialPageRoute(
                                                            builder: (
                                                                context) =>
                                                                SecondHts_Result(widget.personId, labInvestId, widget.visitId, result_string)
                                                        ));
                                                  } else {
                                                    setState(() {
                                                      _showError = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Confirmatory Testing'),
        ),
        // appBar: AppBar(
        //  backgroundColor: Colors.blue,
