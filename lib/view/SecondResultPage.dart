...
import 'package:ehr_mobile/view/ThirdDiscondantPage.dart';
...
class SecondHts_Result extends StatefulWidget {
  String visitId;
  String patientId;
  String labInvetsTestId;
  String result_string;

  SecondHts_Result(this.patientId, this.labInvetsTestId, this.visitId, this.result_string);
...
class _Hts_Result  extends State<SecondHts_Result > {
                                                    ...
                                                    child: RaisedButton(
                                                        ...
                                                        onPressed: () async {
                                                          if (widget.result_string == "Positive") {
                                                            ...
                                                            Navigator.push(context, MaterialPageRoute(builder: (context)=> ThirdHtsScreeningTest(widget.patientId, widget.visitId)));
