...
class LaboratoryInvestigation {
  ...
  factory LaboratoryInvestigation.fromJson(Map<String, dynamic> json) =>
      _$LaboratoryInvestigationFromJson(json);
  ...
  static mapFromJson(List dynamicList) {
    ...
    if (dynamicList != null) {
      dynamicList.forEach((e) {
        LaboratoryInvestigation nationality = LaboratoryInvestigation.fromJson(
            e);
