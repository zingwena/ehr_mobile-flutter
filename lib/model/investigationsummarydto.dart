...
class InvestigationSummaryDto {
  ...
  factory InvestigationSummaryDto.fromJson(Map<String, dynamic> json) =>
      _$InvestigationSummaryDtoFromJson(json);
  ...
  static String listToJson(List<InvestigationSummaryDto> investigations) {
    List<Map<String, String>> x = investigations
        .map((f) => {
              'testName': f.testName,
              'testDate': f.testDate.toIso8601String(),
              'result': f.result
            })
        .toList();
  ...
  static List<InvestigationSummaryDto> mapFromJson(List dynamicList) {
    ...
    if (dynamicList != null) {
      dynamicList.forEach((e) {
        InvestigationSummaryDto investigationSummaryDto =
            InvestigationSummaryDto.fromJson(e);
